...
def init():
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = '1'#args.GPU_ID
...
if __name__ == '__main__':
    # Create test list
    test_input_list = sorted([file for file in os.listdir(args.TEST_DATASET + 'gt_rgb/') if (file.endswith('.jpg') or file.endswith('.png'))])#[::10]
